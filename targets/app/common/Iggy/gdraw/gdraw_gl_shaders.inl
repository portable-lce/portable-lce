...
static char pshader_basic_frag0[] =
    "#version 110        // only need 100, but 110 works around a driver "
    "issue\n"
    ...
    "\n"
    "#define COMMON_PSCONSTANTS DECLARE_CONST(VEC4, color_mul, 0); "
    "DECLARE_CONST(VEC4, color_add, 1); DECLARE_CONST(VEC4, focal, 2); varying "
    "VEC4 tex_coord\n"
    "#define COMMON_PCONSTANTS2 varying VEC4 tex_coord; varying VEC4 "
    "color_mul; varying VEC4 color_add; varying VEC4 clip_rect;\n"
...
static char* pshader_basic_vars[] = {"tex0",      "tex1",  "color_mul",
                                     "color_add", "focal", NULL};
...
static char pshader_general2_frag1[] =
    ...
    "   //\n"
    "   // to determine optimal format for vertex shader to output the color, "
    "let's\n"
    "   // start by doing the math assuming the texture is premultiplied, but "
    "not\n"
    "   // the color transform:\n"
    "   //\n"
    "   //       out.r = (tex.r * color_mul.r * color_mul.a) + (color_add.r * "
    "tex.a * color_mul.a)\n"
    "   //       out.a = tex.a * color_mul.a * color_add.a // color_add.a is "
    "blend mode emulation\n"
    "   //\n"
    "   // now, we can see in the above we can premultiply both mul and add by "
    "color_mul.a\n"
    "   //\n"
    "   //       out.r = (tex.r * color_mulp.r) + (color_addp.r * tex.a)\n"
    "   //       out.a = tex.a * color_mulp.a // can premultiply color_add.a "
    "here as well\n"
    "\n"
    "   \n"
    "   LOWP VEC4 c;\n"
    ...
    "   //\n"
    "   //   And now, with an offset in pixels, we want to compute an AA "
    "mask:\n"
    "   //\n"
    ...
    "\n"
    "   LOWP VEC2 cliprect_alpha = saturate(clip_rect.zw - abs(tex_coord.zw - "
    "clip_rect.xy));\n"
    "\n"
    "   float edge_alpha = cliprect_alpha.x * cliprect_alpha.y;\n"
    "   // could be min, but multiply represents coverage better in theory; "
    "@TODO check visually\n"
    "\n"
    "   // multiply it into c's alpha, but c's already premultiplied so "
    "multiply it all\n"
    "   c *= edge_alpha;\n"
    "\n"
    "   OUTPUT(c);\n"
...
static char* pshader_general2_arr[1][NUMFRAGMENTS_pshader_general2] = {
    {
        pshader_general2_frag0,
        pshader_general2_frag1,
    },
};

static char** pshader_general2(void) { return pshader_general2_arr[0]; }

static char* pshader_general2_vars[] = {"tex0", NULL};
...
static char pshader_exceptional_blend_frag2[] =
    "#define TEX0\n"
    "\n"
    "MEDIUMP float compute(MEDIUMP float s, MEDIUMP float sa, MEDIUMP float d, "
    "MEDIUMP float da)\n"
    "{\n"
    "    BLENDPROG\n"
    "}\n"
...
static char pshader_exceptional_blend_frag10[] =
    "#define BLENDPROG return d < da/2.0 ? (2.0*s*d) : (sa*da - "
    "2.0*(da-d)*(sa-s));\n"
    "#define ALPHAFUNC return sa+da-sa*da;\n";
static char pshader_exceptional_blend_frag11[] =
    "#define BLENDPROG return s < sa/2.0 ? (2.0*s*d) : (sa*da - "
    "2.0*(da-d)*(sa-s));\n"
    "#define ALPHAFUNC return sa+da-sa*da;\n";
...
static char*
    pshader_exceptional_blend_arr[13][NUMFRAGMENTS_pshader_exceptional_blend] =
        {
            {
                NULL,
                NULL,
            ...
            },
            {
                ...
                pshader_exceptional_blend_frag1,
                pshader_exceptional_blend_frag2,
            },
            {
                pshader_exceptional_blend_frag0,
                pshader_exceptional_blend_frag3,
                pshader_exceptional_blend_frag2,
            },
            {
                pshader_exceptional_blend_frag0,
                pshader_exceptional_blend_frag4,
                pshader_exceptional_blend_frag2,
            },
            {
                pshader_exceptional_blend_frag0,
                pshader_exceptional_blend_frag5,
                pshader_exceptional_blend_frag2,
            },
            {
                pshader_exceptional_blend_frag0,
                pshader_exceptional_blend_frag6,
                pshader_exceptional_blend_frag2,
            },
            {
                pshader_exceptional_blend_frag0,
            ...
            {
                pshader_exceptional_blend_frag0,
                pshader_exceptional_blend_frag8,
                pshader_exceptional_blend_frag2,
            },
            {
                pshader_exceptional_blend_frag0,
            ...
            {
                pshader_exceptional_blend_frag0,
                pshader_exceptional_blend_frag11,
                pshader_exceptional_blend_frag2,
            },
            {
                pshader_exceptional_blend_frag0,
                pshader_exceptional_blend_frag12,
                pshader_exceptional_blend_frag2,
            },
            {
                pshader_exceptional_blend_frag0,
                pshader_exceptional_blend_frag13,
                pshader_exceptional_blend_frag2,
            },
};
...
static char* pshader_exceptional_blend_vars[] = {"tex0", "tex1", "color_mul",
                                                 "color_add", NULL};
...
static char pshader_filter_frag2[] =
    ...
    "    MEDIUMP float shadow_a = TEX2D(tex0, CLAMP(TC0.xy + "
    "tc_off.xy,clamp0)).a;\n"
    "    \n"
    "    #ifdef BEVEL\n"
    "    MEDIUMP float shadow_b = TEX2D(tex0, CLAMP(TC0.xy - "
    "tc_off.xy,clamp0)).a;\n"
...
static char* pshader_filter_arr[32][NUMFRAGMENTS_pshader_filter] = {
    {
        pshader_filter_frag0,
        pshader_filter_frag1,
        pshader_filter_frag1,
        pshader_filter_frag1,
        pshader_filter_frag1,
        pshader_filter_frag1,
        pshader_filter_frag2,
    },
    {
        pshader_filter_frag0,
        pshader_filter_frag1,
...
static char** pshader_filter(int bevel, int ontop, int inner, int gradient,
                             int knockout) {
    return pshader_filter_arr[0 + bevel * 16 + ontop * 8 + inner * 4 +
                              gradient * 2 + knockout * 1];
}

static char* pshader_filter_vars[] = {"tex0",   "tex1",   "color",
                                      "tc_off", "tex2",   "clamp0",
                                      "clamp1", "color2", NULL};
...
static char pshader_blur_frag2[] =
    ...
    "    \n"
    "    #define TAP(i) s += TEX2D(tex0, CLAMP(TC0.xy + tap[i].xy)) * "
    "tap[i].z\n"
    "    TAPS\n"
    "    \n"
    "    OUTPUT(s);\n"
...
static char* pshader_blur_vars[] = {"tex0", "tap", "clampv", NULL};
...
static char* pshader_color_matrix_arr[1][NUMFRAGMENTS_pshader_color_matrix] = {
    {
        pshader_color_matrix_frag0,
        pshader_color_matrix_frag1,
    },
};

static char** pshader_color_matrix(void) { return pshader_color_matrix_arr[0]; }

static char* pshader_color_matrix_vars[] = {"tex0", "data", NULL};
...
static char* pshader_manual_clear_arr[1][NUMFRAGMENTS_pshader_manual_clear] = {
    {
        pshader_manual_clear_frag0,
        pshader_manual_clear_frag1,
    },
};

static char** pshader_manual_clear(void) { return pshader_manual_clear_arr[0]; }

static char* pshader_manual_clear_vars[] = {"color_mul", NULL};
...
static char vshader_vsgl_frag2[] =
    ...
    "        void main() {\n"
    "            // world transform\n"
    "            HIGHP vec4 wpos = vec4(dot(world0, position), dot(world1, "
    "position), world0.z, 1.0);\n"
    "            \n"
    "            // texture coordinates\n"
    "            tex_coord = vec4(dot(texgen_s, position), dot(texgen_t, "
    "position), 1.0, 0.0);\n"
    "        #ifdef FORMAT_V2TC2\n"
    ...
    "            gl_Position = vec4(wpos.xy * viewproj.xy + viewproj.zw, "
    "wpos.zw);\n"
    "\n"
    "         #ifdef FLASH_10\n"
    "            gl_Position = wpos.x * x3d + wpos.y * y3d + w3d;  // z is "
    "ignored!\n"
...
static char* vshader_vsgl_vars[] = {"world0",   "world1",   "x_off", "texgen_s",
                                    "texgen_t", "viewproj", NULL};
...
static char vshader_vsglihud_frag1[] =
    ...
    "\n"
    "    // pass additive blending flag stored in c1_add.a and c2_add.a to "
    "pixel shader\n"
    ...
    "    \n"
    "    // coordinates come in already rotated into panel space, which is "
    "also where cliprect is defined\n"
    "    HIGHP VEC2 center = (clip.xy + clip.zw) / 2.0;\n"
    "    HIGHP VEC2 offset = (clip.zw - clip.xy) / 2.0;\n"
    "\n"
    "    // use of pixels_per_panel_unit here ignores effect of non-uniform "
    "scaling\n"
    "    clip_rect.xy = center * pixels_per_panel_unit;\n"
    "    clip_rect.zw = offset * pixels_per_panel_unit + 1.0; // offset is "
    "location where alpha goes to 0, so it's 1 pixel out\n"
    "\n"
...
static char* vshader_vsglihud_arr[1][NUMFRAGMENTS_vshader_vsglihud] = {
    {
        vshader_vsglihud_frag0,
        vshader_vsglihud_frag1,
    },
};
